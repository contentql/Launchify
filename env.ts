...
export const env = createEnv({
  server: {
    ...
    RAILWAY_TEAM_CQL_ACCESS_TOKEN: z.string(),
    RAILWAY_PERSONAL_ACCESS_TOKEN: z.string(),
  ...
  runtimeEnv: {
    ...
    RAILWAY_TEAM_CQL_ACCESS_TOKEN: process.env.RAILWAY_TEAM_CQL_ACCESS_TOKEN,
    RAILWAY_PERSONAL_ACCESS_TOKEN: process.env.RAILWAY_PERSONAL_ACCESS_TOKEN,
