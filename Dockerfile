...
ARG RAILWAY_PERSONAL_ACCESS_TOKEN
ARG RAILWAY_TEAM_CQL_ACCESS_TOKEN
...
ENV RAILWAY_PERSONAL_ACCESS_TOKEN=$RAILWAY_PERSONAL_ACCESS_TOKEN
ENV RAILWAY_TEAM_CQL_ACCESS_TOKEN=$RAILWAY_TEAM_CQL_ACCESS_TOKEN
